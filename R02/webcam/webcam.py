...
class VideoTransformTrack(MediaStreamTrack):
    ...
    def __init__(self, track):
        super().__init__()
        self.track = track
        self.yolo_model = YOLO("best.pt")  # Load your trained YOLO model here
    ...
    async def recv(self):
        ...
        # --- YOLO inference ---
        results = self.yolo_model(img)  # returns a list of results
    ...
    if play_from:
        ...
        if relay is None:
            if platform.system() == "Darwin":
                ...
                webcam = MediaPlayer(
                    'video=Surface Camera Front', format="dshow", options=options
                )
...
async def offer(request: web.Request) -> web.Response:
    ...
    if video:
        ...
        track = VideoTransformTrack(video)
